...
gold1 = world.Item(400,100,50,50,425,100,50,50,"S",0,0,"default",ids.gold_img_dic)
...
wood = world.Item(300,300,50,50,325,300,50,50,"S",0,0,"default",ids.wood_img_dic)
...
tower = world.Wall(300,250,50,100,300,300,50,50,"S",0,0,"default",ids.Tower_img_dic)
...
def frame_loop(*args):
    ...
    if lastTime%5 ==0:
        ...
        window.sendXY(warrior.get_x(),warrior.get_y())
