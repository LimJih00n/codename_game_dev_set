...
def game_com_codition():
    ...
    if kill_count == 2 and Item_count==2:
        return True
    return False
...
goblin = world.Wall(200,200,ids.goblin_img_dic,"goblin",50)
goblin_draw = DrawImage(goblin)
World_objects_draw.append((goblin,goblin_draw))
World_Walls.append(goblin)


goblin2 = world.Wall(400,300,ids.goblin_img_dic,"goblin",50)
goblin2_draw = DrawImage(goblin2)
World_objects_draw.append((goblin2,goblin2_draw))
World_Walls.append(goblin2)
...
tree3 = world.Wall(75,330,ids.tree_img_dic,"tree",1000)
tree3_draw = DrawImage(tree3)
World_objects_draw.append((tree3,tree3_draw))
World_Walls.append(tree3)

tree4 = world.Wall(175,330,ids.tree_img_dic,"tree",1000)
tree4_draw = DrawImage(tree4)
World_objects_draw.append((tree4,tree4_draw))
World_Walls.append(tree4)


tree5 = world.Wall(275,330,ids.tree_img_dic,"tree",1000)
tree5_draw = DrawImage(tree5)
World_objects_draw.append((tree5,tree5_draw))
World_Walls.append(tree5)
...
goblin.move_rectangle(200,200,400,300)
################## init val and func ################
...
def frame_loop(*args):
    ...
    if lastTime%5 ==0: # 12frame / 1sec
        ...
        goblin.move_rectangle(250,250,450,300)
