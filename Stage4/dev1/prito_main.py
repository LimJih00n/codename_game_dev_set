...
gold1 = world.Item(400,200,ids.gold_img_dic,"gold",0)
...
for i in range(15):
    ...
    tree = world.Wall(10+random.randint(1,400),50+random.randint(-20,50),ids.tree_img_dic,"tree",1000)
    tree_draw = DrawImage(tree)
    World_objects_draw.append((tree,tree_draw))
    World_Walls.append(tree)

for i in range(15):
    tree = world.Wall(10+random.randint(1,400),300+random.randint(-50,50),ids.tree_img_dic,"tree",1000)
    tree_draw = DrawImage(tree)
    World_objects_draw.append((tree,tree_draw))
    World_Walls.append(tree)
