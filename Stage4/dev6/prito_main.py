...
gold1 = world.Item(400,50,ids.gold_img_dic,"gold",0)
gold1_draw = DrawImage(gold1)
World_objects_draw.append((gold1,gold1_draw))
World_Items.append(gold1)

gold2 = world.Item(100,200,ids.gold_img_dic,"gold",0)
...
World_objects_draw.append((gold3,gold3_draw))
World_Items.append(gold3)
...
for i in range(1):
    castle = world.Wall(400,100,ids.Castle_img_dic,"wall",10000)
    castle_draw = DrawImage(castle)
    World_objects_draw.append((castle,castle_draw))
    World_Walls.append(castle)
...
for i in range(1):
    ...
    castle = world.Wall(i*100,300,ids.Castle_img_dic,"wall",10000)
    castle_draw = DrawImage(castle)
    World_objects_draw.append((castle,castle_draw))
    World_Walls.append(castle)
...
for i in range(2):
    ...
    castle = world.Wall(i*100+300,300,ids.Castle_img_dic,"wall",10000)
    castle_draw = DrawImage(castle)
    World_objects_draw.append((castle,castle_draw))
    World_Walls.append(castle)


tree1 = world.Wall(125,330,ids.tree_img_dic,"tree",1000)
tree1_draw = DrawImage(tree1)
World_objects_draw.append((tree1,tree1_draw))
World_Walls.append(tree1)


tree2 = world.Wall(275,130,ids.tree_img_dic,"tree",1000)
tree2_draw = DrawImage(tree2)
World_objects_draw.append((tree2,tree2_draw))
World_Walls.append(tree2)


tree3 = world.Wall(225,330,ids.tree_img_dic,"tree",1000)
